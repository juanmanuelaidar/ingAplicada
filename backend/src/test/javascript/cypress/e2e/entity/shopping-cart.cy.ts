...
describe('ShoppingCart e2e test', () => {
  ...
  const shoppingCartSample = { createdDate: '2026-05-22T11:43:31.643Z', status: 'bashfully yahoo entwine' };
  ...
  describe('new ShoppingCart page', () => {
    ...
    it('should create an instance of ShoppingCart', () => {
      cy.get(`[data-cy="createdDate"]`).type('2026-05-21T21:18');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2026-05-21T21:18');
