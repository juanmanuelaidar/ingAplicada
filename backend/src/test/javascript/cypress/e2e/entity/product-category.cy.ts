...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'summary' };
  ...
  describe('new ProductCategory page', () => {
    ...
    it('should create an instance of ProductCategory', () => {
      cy.get(`[data-cy="name"]`).type('bowling');
      cy.get(`[data-cy="name"]`).should('have.value', 'bowling');

      cy.get(`[data-cy="description"]`).type('tousle prime');
      cy.get(`[data-cy="description"]`).should('have.value', 'tousle prime');
