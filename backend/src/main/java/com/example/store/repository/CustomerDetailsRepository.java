...
public interface CustomerDetailsRepository extends JpaRepository<CustomerDetails, Long> {
    @Query("select customerDetails from CustomerDetails customerDetails where customerDetails.user.login = ?#{authentication.name}")
    List<CustomerDetails> findByUserIsCurrentUser();
