            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('stock')}>
                  <Translate contentKey="storeApp.product.stock">Stock</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('stock')} />
                </th>
                <th>
                  <Translate contentKey="storeApp.product.category">Category</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {productList.map((product, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{product.price}</td>
                  <td>{product.stock}</td>
                  <td>{product.category ? <Link to={`/product-category/${product.category.id}`}>{product.category.name}</Link> : ''}</td>
