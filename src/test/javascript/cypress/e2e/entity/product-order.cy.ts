...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { placedDate: '2026-06-03T06:05:14.324Z', quantity: 1019 };
  ...
  describe('new ProductOrder page', () => {
    ...
    it('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2026-06-03T18:05');
      cy.get(`[data-cy="placedDate"]`).blur();
      cy.get(`[data-cy="placedDate"]`).should('have.value', '2026-06-03T18:05');
