...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'soft', price: 510.17, stock: 8626 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('gaseous');
      cy.get(`[data-cy="name"]`).should('have.value', 'gaseous');

      cy.get(`[data-cy="price"]`).type('20322.22');
      cy.get(`[data-cy="price"]`).should('have.value', '20322.22');

      cy.get(`[data-cy="stock"]`).type('7366');
      cy.get(`[data-cy="stock"]`).should('have.value', '7366');
