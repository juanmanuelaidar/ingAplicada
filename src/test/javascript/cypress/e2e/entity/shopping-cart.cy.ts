...
describe('ShoppingCart e2e test', () => {
  ...
  const shoppingCartSample = { createdDate: '2026-06-03T16:50:26.643Z', status: 'bashfully yahoo entwine' };
  ...
  describe('new ShoppingCart page', () => {
    ...
    it('should create an instance of ShoppingCart', () => {
      cy.get(`[data-cy="createdDate"]`).type('2026-06-03T02:25');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2026-06-03T02:25');

      cy.get(`[data-cy="status"]`).type('crossly');
      cy.get(`[data-cy="status"]`).should('have.value', 'crossly');
