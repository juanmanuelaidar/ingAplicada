...
import com.example.store.config.SecurityJwtConfiguration;
import com.example.store.config.WebConfigurer;
import com.example.store.management.SecurityMetersService;
import com.example.store.web.rest.AuthenticateController;
